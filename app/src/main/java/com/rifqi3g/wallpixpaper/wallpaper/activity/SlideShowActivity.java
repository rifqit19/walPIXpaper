...
public class SlideShowActivity extends DialogFragment {

    private String TAG = com.rifqi3g.wallpixpaper.wallpaper.activity.SlideshowDialogFragment.class.getSimpleName();
    private List<SaveObj> images;
...
// instantiate it within the onCreate method
        ...
        public static SlideShowActivity newInstance() {
            SlideShowActivity f = new SlideShowActivity();
            return f;
        }

        @Override
        public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
            View v = inflater.inflate(R.layout.activity_slide_show, container, false);
            viewPager = (ViewPager) v.findViewById(R.id.viewpager1);
            lblCount = (TextView) v.findViewById(R.id.lbl_count1);
            lblTitle = (TextView) v.findViewById(R.id.title1);
            img_download = v.findViewById(R.id.img_download1);
            back = v.findViewById(R.id.backSA);
            floatingActionMenu = v.findViewById(R.id.material_design_android_floating_action_menu1);
...
//            View overlay = v.findViewById(R.id.slideShowActivityLyt);
//            overlay.setSystemUiVisibility(View.SYSTEM_UI_FLAG_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY | View.SYSTEM_UI_FLAG_FULLSCREEN);

//        lblDate = (TextView) v.findViewById(R.id.date);

            FloatingActionMenu floatingActionMenu = v.findViewById(R.id.material_design_android_floating_action_menu1);
            btnWallpaper = (FloatingActionButton) v.findViewById(R.id.btnWallpaper1);
            share = v.findViewById(R.id.btn_share1);
            web = v.findViewById(R.id.webweb1);
            ...
            images = realmHelper.getFav();

            mFirebaseAnalytics = FirebaseAnalytics.getInstance(getContext());

//            images = (ArrayList<SaveObj>) getArguments().getSerializable("images");
            selectedPosition = getArguments().getInt("position");

            myViewPagerAdapter = new MyViewPagerAdapter2();
        ...
        private void displayMetaInfo(int position) {
            ...
            final SaveObj image = images.get(position);
...
//    }
        ...
        public class MyViewPagerAdapter2 extends PagerAdapter {
            ...
            public Object instantiateItem(ViewGroup container, int position) {
                ...
                Picasso.get().load(image.getLargeImageURL()).into(imageViewPreview);
        ...
        public void shareArticle(){
            ...
            final SaveObj imageSel = images.get(vpPosition);
        ...
        public void goToWeb(){
            ...
            String web = imageSel.getPageURL();
            Log.e("web", vpPosition+" " + web);
